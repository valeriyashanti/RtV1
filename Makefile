...
#    Updated: 2019/02/16 19:27:20 by gkessler         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

MAIN = main.c
SRCS = main.c vec_sc.c cone.c roll.c plane.c on_button_press.c ray_tracing.c get_light.c ray_sphere.c rtv1.c ft_atoi_base.c parser.c parse_object.c strclen.c vec_operations.c
